                ...
                <div id="header-wrap">
                    ...
                    <nav id="primary-menu" class="style-2">
                        <div class="container clearfix">
                            ...
                            <ul>
                                <li><a href="?"><div>Home</div><span></span></a></li>
                                <li><a href="?controller=User&action=loginUser"><div>Start</div><span>Start</span></a></li>
                            </ul>

                            <div id="top-search">
                                <a href="#" id="top-search-trigger"><i class="icon-search3"></i><i class="icon-line-cross"></i></a>
                                <form action="?controller=Product&action=search" method="post">
                                    <input type="text" name="search" class="form-control" value="" placeholder="Search a product">
                                </form>
                            </div><!-- #top-search end -->
                        </div>
